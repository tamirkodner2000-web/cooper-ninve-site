...
const productIcons = {
  professional: `<svg aria-hidden="true" focusable="false" viewBox="0 0 32 32" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="8" r="3"/><path d="M5.5 23c.8-4.5 2.6-7 5.5-7s4.7 2.5 5.5 7"/><rect x="14" y="15" width="12" height="8" rx="1.5"/><path d="M17 27h6"/><path d="M20 23v4"/><path d="M18 18h4"/><path d="M23 8h5v10"/><path d="M20 8h-3"/><path d="M23 8v4h-5"/></svg>`,
  ...
  thirdParty: `<svg aria-hidden="true" focusable="false" viewBox="0 0 32 32" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="10" r="3"/><path d="M4 24c.8-4.2 2.5-6.3 5-6.3s4.2 2.1 5 6.3"/><circle cx="23" cy="10" r="3"/><path d="M18 24c.8-4.2 2.5-6.3 5-6.3s4.2 2.1 5 6.3"/><path d="M13.5 15.5h5"/><path d="M17 13.5 19 15.5 17 17.5"/><path d="M15 17.5 13 15.5 15 13.5"/></svg>`,
  ...
  directors: `<svg aria-hidden="true" focusable="false" viewBox="0 0 32 32" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="16" cy="8" r="3.5"/><path d="M8.5 27c1.1-5 3.6-7.5 7.5-7.5s6.4 2.5 7.5 7.5"/><path d="M13.5 20 16 24.5 18.5 20"/><path d="M14 13h4"/><rect x="5" y="15" width="7" height="5" rx="1"/><rect x="20" y="15" width="7" height="5" rx="1"/><path d="M12 17.5h8"/><path d="M8.5 15v-2h15v2"/></svg>`,
