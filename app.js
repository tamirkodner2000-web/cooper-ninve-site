...
const products = [
  { title: "ביטוח אחריות מקצועית", url: "/professional-liability-insurance", icon: "◎", text: "הגנה מפני תביעות הנובעות מטעות מקצועית, רשלנות, ייעוץ שגוי או מחדל במסגרת מתן שירות מקצועי." },
  { title: "ביטוח סייבר", url: "/cyber-insurance", icon: "◈", text: "כיסוי לאירועי סייבר, מתקפות כופר, דליפות מידע, השבתת פעילות, הוצאות שחזור ותביעות צד שלישי." },
  { title: "ביטוח עבודות קבלניות", url: "/contractors-all-risks-insurance", icon: "▧", text: "פתרונות ביטוח לפרויקטים, קבלנים, יזמים ועבודות תשתית, כולל רכוש, צד שלישי וחבות מעבידים." },
  { title: "ביטוח רשלנות רפואית", url: "/medical-malpractice-insurance", icon: "✚", text: "פתרונות לרופאים, מטפלים, מרפאות וגורמים רפואיים החשופים לתביעות בגין רשלנות מקצועית." },
  { title: "ביטוח חבויות וצד שלישי", url: "/liability-insurance", icon: "◇", text: "כיסוי לעסקים מפני תביעות צד שלישי בגין נזקי גוף, רכוש או אחריות הנובעת מהפעילות העסקית." },
];
...
function solutionsSections() {
  return `
    <section class="section">
      <div class="container">
        <div class="center-title"><h2>תחומי הביטוח המרכזיים שלנו</h2><p>עמוד מרכזי שמוביל למוצרי הביטוח ולמסלולי הפנייה המתאימים.</p></div>
        ${productCards()}
      </div>
    </section>
